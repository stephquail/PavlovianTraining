...
CI110 <- c("R/data/CI110.log", "CI110", 10)
CI111 <- c("R/data/CI111.log", "CI111", 11)
CI112 <- c("R/data/CI112.log", "CI112", 12)
CI113 <- c("R/data/CI113.log", "CI113", 13)
CI114 <- c("R/data/CI114.log", "CI114", 14)
CI115 <- c("R/data/CI115.log", "CI115", 15)
CI116 <- c("R/data/CI116.log", "CI116", 16)
CI117 <- c("R/data/CI117.log", "CI117", 17)
CI118 <- c("R/data/CI118.log", "CI118", 18)
CI119 <- c("R/data/CI119.log", "CI119", 19)
CI120 <- c("R/data/CI120.log", "CI120", 20)
CI121 <- c("R/data/CI121.log", "CI121", 21)
CI122 <- c("R/data/CI122.log", "CI122", 22)
